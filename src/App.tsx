...
import { Train, Ticket, Activity, MapPin, Clock, AlertTriangle, Menu, Settings, Monitor } from 'lucide-react';

type Tab = 'pnr' | 'live_status' | 'live_station' | 'trains_between' | 'schedule' | 'exceptional' | 'stations' | 'settings' | 'observability';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row text-slate-900 font-sans sm:overflow-hidden transition-colors duration-500">
